...
> **Vendor documentation, not this project's.** Auto-generated by
> `crewai create`, where it landed in the repository root as `AGENTS.md`.
> It was moved here because that filename is the cross-agent convention for
> *project* instructions — an assistant opening this repo needs to be told
> about this project first, and this file is 1,000 lines about the framework.
> `AGENTS.md` now holds the project instructions and links here.
>
> **Read this before writing or modifying any CrewAI code.** The library moves
> quickly and the patterns below are more current than most training data.
>
> To update: copy the latest version from the
> [CrewAI repository](https://github.com/crewAIInc/crewAI) and keep it at this
> path rather than restoring it to the root.
