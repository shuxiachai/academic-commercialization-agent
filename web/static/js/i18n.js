...
const STRINGS = {
  English: {
    ...
    decision_context_note: "This context is sent to the configured model provider and stored with the run. Unsupported budgets, timelines, and thresholds must remain ‘not established’.",
  ...
  "Simplified Chinese": {
    ...
    decision_context_note: "这些内容会发送给已配置的模型服务商，并随本次运行保存。没有证据支持的预算、周期与阈值必须标记为“尚未确定”。",
