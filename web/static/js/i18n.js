...
const STRINGS = {
  English: {
    ...
    byok_hint: "Keys: platform.deepseek.com/api-keys · platform.kimi.ai · platform.openai.com/api-keys · console.anthropic.com — and serper.dev/api-key for search (free tier available).",
    byok_submit: "Start",
  ...
  "Simplified Chinese": {
    ...
    byok_llm_placeholder: "LLM API Key",
    byok_serper_placeholder: "Serper API Key",
    byok_hint: "获取密钥：platform.deepseek.com/api-keys · platform.kimi.ai · platform.openai.com/api-keys · console.anthropic.com；检索用的 serper.dev/api-key 有免费额度。",
    byok_submit: "开始",
