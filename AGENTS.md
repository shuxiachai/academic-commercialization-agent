...
RQ is now [closed after two native synthetic cases](docs/results-2026-09-20-saved-source-receipt-qwen-canary.md):
2/2 mechanical/reference gates and explicit lost-ack receipt recovery, with no
