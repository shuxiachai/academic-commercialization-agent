...
| Isolated saved-evidence follow-up | `report_evidence_snapshot.py`, `report_evidence_followup.py` | [Read-only conversation contract](docs/report-evidence-followup.md); no provider transport or production route |
