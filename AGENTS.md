...
| Isolated saved-evidence follow-up | `report_evidence_snapshot.py`, `report_evidence_followup.py`, `report_evidence_guarded_followup.py`, `report_evidence_qwen_transport.py`, `report_evidence_qwen_canary.py` | [Read-only conversation contract](docs/report-evidence-followup.md), [offline stage policy](docs/prereg-2026-09-15-report-evidence-stage-policy.md) and [frozen synthetic canary](docs/prereg-2026-09-14-report-evidence-followup-qwen.md); do not route the new policy into the old live runner; no production route |
