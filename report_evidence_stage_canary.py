"""Check frozen stage-canary identity by default; paid mode needs fresh permission."""

import argparse
import json
from pathlib import Path

from academic_agent.report_evidence_stage_qwen_canary import (
...
class _Parser(argparse.ArgumentParser):
    def error(self, message):
        ...
        self.exit(2, "invalid_stage_canary_arguments\n")
...
def main(argv=None) -> int:
    ...
    try:
        ...
        print(json.dumps({"passed": False, "error": "stage_canary_setup_or_persistence_failed"}))
    return 1
